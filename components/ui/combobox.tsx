            ...
            <Pressable onPress={() => {}}>
              <View className="p-3 pb-2">
                <View
                  ...
                  className="h-11 flex-row items-center gap-2 rounded-[10px] px-3">
                  <Icon name="magnifyingglass" size={16} color={c.muted} />
                  <TextInput
                    value={query}
                    ...
                    autoFocus
                    style={{ flex: 1, color: c.text, fontFamily: LexendFonts.regular }}
                  />
                </View>
              </View>
              {filtered.length === 0 ? (
                <ThemedText className="p-3 opacity-60" style={{ color: c.text }}>
                  No results
                </ThemedText>
              ) : (
